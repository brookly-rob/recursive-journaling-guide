...
function displayPrompt(prompt) {
    ...
    promptText.textContent = "Check the Evaluation Menu below to see your awards and trophies so far. Glowing items are additional activities that earn Arc Trophies by completing self-reflection arcs. You can also close the app and reopen to receive the next pop-up activity. Pulling down to refresh will begin any eligible Deeper Insight activities due.";
